...
def train(network, criterion, train_dataloader, val_dataloader, device, batch_size, num_epochs, lr,
...
def smooth(train_acc, train_loss, train_loss1, train_loss2):
    train_acc_ave, train_loss_ave, train_loss1_ave, train_loss2_ave = Smooth(train_acc, train_loss, train_loss1,
                                                                             train_loss2)
    plt.figure()
    plt.subplot(2, 2, 1)
    plt.plot(1 + np.arange(len(train_loss_ave)), train_loss_ave, linewidth=1.5, linestyle='dashed',
             label='train_loss_smooth')
    plt.subplot(2, 2, 2)
    plt.plot(1 + np.arange(len(train_loss1_ave)), train_loss1_ave, linewidth=1.5, linestyle='dashed',
             label='train_loss1_smooth')
    plt.subplot(2, 2, 3)
    plt.plot(1 + np.arange(len(train_loss2_ave)), train_loss2_ave, linewidth=1.5, linestyle='dashed',
             label='train_loss2_smooth')
    plt.subplot(2, 2, 4)
    plt.plot(1 + np.arange(len(train_acc_ave)), train_acc_ave, linewidth=1.5, linestyle='dashed',
             label='train_acc_smooth')
    plt.grid()
    plt.xlabel('epoch')
...
if __name__ == '__main__':
    ...
    train_acc, train_loss, train_loss1, train_loss2, eval_acces = train(network, criterion, train_dataloader,
                                                                        val_dataloader, device, batch_size=4,
                                                                        num_epochs=500, lr=1e-5)
